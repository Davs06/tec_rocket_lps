...
<head>
    ...
    <link rel="icon" type="image/png" href="/assets/img/favicon_bratz/favicon-96x96.png" sizes="96x96" />
    <link rel="icon" type="image/svg+xml" href="/assets/img/favicon_bratz/favicon.svg" />
    <link rel="shortcut icon" href="/favicon.ico" />
    <link rel="apple-touch-icon" sizes="180x180" href="/assets/img/favicon_bratz/apple-touch-icon.png" />
    <meta name="apple-mobile-web-app-title" content="Bratz Style" />
    <link rel="manifest" href="/assets/img/favicon_bratz/site.webmanifest" />
