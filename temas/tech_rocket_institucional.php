...
<body class="font-sans relative">
    ...
    <div
        class="fixed top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-indigo-600/20 blur-[120px] -z-10 pointer-events-none animate-pulse">
    </div>
    <div
        class="fixed bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-cyan-600/10 blur-[120px] -z-10 pointer-events-none animate-pulse">
    </div>
    ...
    <nav class="p-6 flex justify-between items-center max-w-10xl mx-auto">
        ...
        <div class="hidden md:flex gap-8 text-sm font-medium uppercase tracking-widest">
            <a href="#produtos" class="hover:text-indigo-400 transition-colors">Produtos</a>
            <a href="#servicos" class="hover:text-indigo-400 transition-colors">Serviços</a>
            <a href="#parceiros" class="hover:text-indigo-400 transition-colors">Parceiros</a>
            <a href="#contato"
                class="bg-indigo-600/80 hover:bg-indigo-600 px-4 py-2 rounded-full border border-indigo-500/50 transition-all">Orçamento</a>
        </div>
    </nav>
    ...
    <header class="py-20 px-6 text-center max-w-10xl mx-auto hero-section" data-aos="zoom-in">
        ...
        <div class="flex flex-col md:flex-row justify-center gap-4">
            <a href="#contato"
                class="bg-indigo-600 hover:bg-indigo-500 px-10 py-4 rounded-full font-bold text-lg transition shadow-[0_0_20px_rgba(99,102,241,0.5)] border border-indigo-400/50">
                Iniciar um Projeto
            </a>
            <a href="#produtos"
                class="rocket-card px-10 py-4 rounded-full font-bold text-lg hover:text-white transition group">
                Ver Nossos Produtos
            </a>
        </div>
    </header>

    <section id="produtos" class="py-20 px-6 max-w-7xl mx-auto relative">
        <h2 class="text-3xl font-bold mb-12 text-center">Nossos <span class="text-indigo-400">Projetos & Produtos</span>
        </h2>

        <div class="grid md:grid-cols-2 gap-8">
            <div class="rocket-card p-8 rounded-3xl flex flex-col gap-6 group" data-aos="fade-right">
                <div class="overflow-hidden rounded-2xl">
                    <img src="/assets/img/Maternidade-e-Lucro.png" alt="Ebook Maternidade e Lucro"
                        class="w-full h-48 object-cover shadow-lg group-hover:scale-105 transition-transform duration-500">
                </div>
                <div>
                    <h3 class="text-2xl font-bold mb-2">Maternidade & Lucro</h3>
                    <span
                        class="text-xs font-mono bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded border border-indigo-500/30">E-book</span>
                </div>
                ...
                <a href="https://maternidade.techrocket.site"
                    class="text-indigo-400 font-bold hover:text-indigo-300 transition flex items-center gap-2">
                    Ver Projeto <span>→</span>
                </a>
            </div>

            <div class="rocket-card p-8 rounded-3xl flex flex-col gap-6 group" data-aos="fade-left">
                <div class="overflow-hidden rounded-2xl">
                ...
                <div>
                    ...
                    <span
                        class="text-xs font-mono bg-indigo-500/20 text-indigo-300 px-2 py-1 rounded border border-indigo-500/30">E-commerce</span>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="rocket-card p-8 rounded-3xl" data-aos="fade-up" data-aos-delay="100">
                    <div class="text-4xl mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">🚀</div>
                ...
                <div class="rocket-card p-8 rounded-3xl" data-aos="fade-up" data-aos-delay="200">
                    <div class="text-4xl mb-4 drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]">🤖</div>
                ...
                <div class="rocket-card p-8 rounded-3xl" data-aos="fade-up" data-aos-delay="300">
                    <div class="text-4xl mb-4 drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">⚙️</div>
                ...
                <div class="rocket-card p-8 rounded-3xl" data-aos="fade-up" data-aos-delay="400">
                    <div class="text-4xl mb-4 drop-shadow-[0_0_10px_rgba(251,191,36,0.5)]">🛍️</div>
    ...
    <section id="contato" class="py-20 px-6 max-w-4xl mx-auto text-center" data-aos="fade-up">
        ...
        <form action="/processa.php" method="POST"
            class="rocket-card p-8 md:p-12 rounded-3xl text-left border-t border-indigo-500/20">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="nome" required class="w-full rounded-xl p-4">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-2 text-slate-300">E-mail</label>
                    <input type="email" name="email" required class="w-full rounded-xl p-4">
                </div>
            </div>
            <div class="mb-6">
                <label class="block text-sm font-medium mb-2 text-slate-300">WhatsApp</label>
                <input type="text" name="whatsapp" required class="w-full rounded-xl p-4">
            </div>
            <button type="submit"
                class="w-full bg-indigo-600 hover:bg-indigo-500 py-4 rounded-xl font-bold text-lg transition shadow-lg shadow-indigo-500/20 border border-indigo-400/20">
                Enviar Solicitação
            </button>
        </form>
    </section>
    ...
    <footer
        class="py-10 border-t border-slate-800 text-center text-slate-500 text-sm relative z-10 bg-slate-950/50 backdrop-blur-md">
